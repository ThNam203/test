...
//import com.worthybitbuilders.squadsense.databinding.ActivityGroupCallVideoBinding;
...
//
//public class GroupCallVideoActivity extends AppCompatActivity {
//    private static final int PERMISSIONS_REQUEST_CODE = 100;
//    private ActivityGroupCallVideoBinding binding;
...
//            mediaPlayer.setDataSource(GroupCallVideoActivity.this, ringtoneUri);
//            mediaPlayer.prepare();
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
...
//        binding = ActivityGroupCallVideoBinding.inflate(getLayoutInflater());
...
//                runOnUiThread(() -> {
//                    ToastUtils.showToastError(GroupCallVideoActivity.this, "Call denied", Toast.LENGTH_LONG);
//                });
//                rtcClient.endCall();
//                finish();
//            });
...
//        Glide
//                .with(GroupCallVideoActivity.this)
...
//            Log.d("GroupCallVideoActivity", "onConnectionChange" + newState.name());
//        }
//
//        @Override
//        public void onSignalingChange(PeerConnection.SignalingState signalingState) {
//            Log.d("GroupCallVideoActivity", "onSignalingChange" + signalingState.toString());
//        }
//
//        @Override
//        public void onIceConnectionChange(PeerConnection.IceConnectionState iceConnectionState) {
//            Log.d("GroupCallVideoActivity", "onIceConnectionChange" + iceConnectionState.toString());
//            if (iceConnectionState == PeerConnection.IceConnectionState.DISCONNECTED) finish();
//        }
//
//        @Override
//        public void onIceConnectionReceivingChange(boolean b) {
//            Log.d("GroupCallVideoActivity", "onIceConnectionReceivingChange");
//        }
//
//        @Override
//        public void onIceGatheringChange(PeerConnection.IceGatheringState iceGatheringState) {
//            Log.d("GroupCallVideoActivity", "onIceGatheringChange" + iceGatheringState.toString());
//        }
//
//        @Override
//        public void onIceCandidate(IceCandidate iceCandidate) {
//            Log.d("GroupCallVideoActivity", "onIceCandidate");
//            if (rtcClient != null)
...
//            Log.d("GroupCallVideoActivity", "onIceCandidatesRemoved");
//        }
//
//        @Override
//        public void onAddStream(MediaStream mediaStream) {
//            Log.d("GroupCallVideoActivity", "onAddStream");
//            mediaStream.videoTracks.get(0).addSink(binding.remoteView);
//        }
//
//        @Override
//        public void onRemoveStream(MediaStream mediaStream) {
//            Log.d("GroupCallVideoActivity", "onRemoveStream");
//        }
//
//        @Override
//        public void onDataChannel(DataChannel dataChannel) {
//            Log.d("GroupCallVideoActivity", "onDataChannel");
//        }
//
//        @Override
//        public void onRenegotiationNeeded() {
//            Log.d("GroupCallVideoActivity", "onRenegotiationNeeded");
//        }
//
//        @Override
...
//        Log.d("GroupCallVideoActivity", "onReceiveIceCandidate");
